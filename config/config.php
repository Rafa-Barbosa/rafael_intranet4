 ...
 */
$config['base'] 	= 'C:\xampp\htdocs\intranet4/';
$config['baseFW'] 	= 'C:\xampp\htdocs\intranet4/twsfw4/';
$config['baseS3'] 	= 'C:\xampp\htdocs\intranet4/s3/';

$config['include'] 	= $config['baseFW'].'includes/';
$config['modulos'] 	= $config['baseFW'].'modulos/';

$protocolo = 'http://';
$config['raiz'] 	= $protocolo.$_SERVER['HTTP_HOST'].'/intranet4/';
$config['raizS3'] 	= $protocolo.$_SERVER['HTTP_HOST'].'/intranet4/s3/';
$config["raizTemp"]  = $protocolo.$_SERVER['HTTP_HOST'].'/intranet4/temp/';
